// ============================================================
//  All copy for Sneha's Birthday
//  Written in a warm, real, respectful and teasing boy-to-girl voice.
//  Story: Met in a game lobby -> Online gaming partners -> Soulmates.
//  Communication: 100% Text/Chat connection (pure emotional bond).
//  Tone: Genuine, sweet, informal Hinglish, 100% human and relatable.
// ============================================================
...
// --- Why you're special (10 Cards: Genuine, sweet, cute & flirty) ---
export const COMPLIMENTS = [
  ...
  {
    emoji: '💬',
    title: 'Late Night Sukoon Bhari Baatein',
...
// --- Scrapbook memories with curated sticker references & secret back notes ---
...
export const LOVE_COUPONS = [
  {
    id: 1,
    icon: '🫦',
    title: 'Cheek Squish & Hug Pass',
    desc: 'Jab bhi milenge — unlimited gaal kheenchne aur tight cuddles ka legal haq!',
    stamp: 'HAMESHA VALID',
    customSticker: 'assets/kisses/milk_mocha_kiss_3.gif',
  ...
  },
  {
    id: 2,
    icon: '🍦',
    title: 'Late Night Treat Delivery',
    desc: 'Jab bhi ice cream, chocolate ya favourite khane ka man kare, turant order milega!',
    stamp: 'ON-DEMAND',
  ...
  },
  {
    id: 3,
    icon: '👑',
    title: 'Mommy Is Always Right Ticket',
    desc: 'Mommy 100% sahi hain, chahe jo bhi baat ho. Koi arguments nahi 😜',
...
// --- Handwritten Letter (100% Human, Personal, Emotional & Real) ---
...
// --- Explorer props (interactive wonderland objects) ------------
...
// ============================================================
//  🌟 100% CENTRALIZED UI TEXT FOR ALL PAGES
// ============================================================
